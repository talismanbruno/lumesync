...
const CONFIG: Config = {
	families: {
		neutralDark: {hue: 210, saturation: 6, useSaturationFactor: true},
		neutralLight: {hue: 220, saturation: 10, useSaturationFactor: true},
		brand: {hue: 191, saturation: 100, useSaturationFactor: true},
		link: {hue: 191, saturation: 100, useSaturationFactor: true},
...
hsl(258, calc(10% * var(--saturation-factor)), 2%) 10%
			...
			{
				name: '--background-modifier-selected',
				value: 'color-mix(in srgb, var(--brand-primary) 14%, hsla(0, 0%, 100%, 0.035))',
			},
...
hsl(245, calc(100% * var(--saturation-factor)), 80%) 40%
			...
			{name: '--button-primary-fill', value: 'var(--brand-primary)'},
			{name: '--button-primary-active-fill', value: 'var(--brand-secondary)'},
			{name: '--button-primary-text', value: 'var(--text-on-brand-primary)'},
...
hsl(258, calc(10% * var(--saturation-factor)), 0%) 10%
			...
			{
				name: '--background-modifier-selected',
				value: 'color-mix(in srgb, var(--brand-primary) 12%, hsla(0, 0%, 100%, 0.025))',
			},
