...
export const THEME_VARIABLES: ReadonlyArray<ThemeVariableDefinition> = [
	...
	{name: "--lume-bg-canvas", kind: "color", groupId: "surfaces", groupLabel: "Surfaces", source: "globals"},
	{name: "--lume-bg-elevated", kind: "color", groupId: "surfaces", groupLabel: "Surfaces", source: "globals"},
	{name: "--lume-bg-panel", kind: "color", groupId: "surfaces", groupLabel: "Surfaces", source: "globals"},
	{name: "--lume-bg-rail", kind: "color", groupId: "surfaces", groupLabel: "Surfaces", source: "globals"},
	{name: "--lume-cyan", kind: "color", groupId: "other", groupLabel: "Other", source: "globals"},
	{name: "--lume-cyan-line", kind: "color", groupId: "other", groupLabel: "Other", source: "globals"},
	{name: "--lume-cyan-soft", kind: "color", groupId: "other", groupLabel: "Other", source: "globals"},
	{name: "--lume-easing", kind: "other", groupId: "other", groupLabel: "Other", source: "globals"},
	{name: "--lume-glow", kind: "dimension", groupId: "other", groupLabel: "Other", source: "globals"},
	{name: "--lume-line", kind: "color", groupId: "other", groupLabel: "Other", source: "globals"},
	{name: "--lume-shadow", kind: "dimension", groupId: "other", groupLabel: "Other", source: "globals"},
...
export const THEME_STUDIO_DARK_DEFAULT_VARIABLE_VALUES: Readonly<Record<string, string>> = {
	...
	"--accent-info": "hsl(191, calc(100% * var(--saturation-factor)), 70%)",
	"--accent-primary": "hsl(191, calc(100% * var(--saturation-factor)), 50%)",
	...
	"--alert-note-color": "hsl(191, calc(100% * var(--saturation-factor)), 70%)",
	"--alert-tip-color": "hsl(152, calc(72% * var(--saturation-factor)), 45%)",
	"--alert-warning-color": "hsl(45, calc(93% * var(--saturation-factor)), 55%)",
	"--ansi-bg-black": "color-mix(in srgb, hsl(0, 0%, 12%) 88%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 12%)",
	"--ansi-bg-blue": "color-mix(in srgb, hsl(207, calc(61% * var(--saturation-factor)), 59%) 88%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 12%)",
	"--ansi-bg-bright-black": "color-mix(in srgb, hsl(0, 0%, 50%) 88%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 12%)",
	"--ansi-bg-bright-blue": "color-mix(in srgb, hsl(207, calc(61% * var(--saturation-factor)), 59%) 92%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 8%)",
	"--ansi-bg-bright-cyan": "color-mix(in srgb, hsl(168, calc(53% * var(--saturation-factor)), 55%) 92%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 8%)",
	"--ansi-bg-bright-green": "color-mix(in srgb, hsl(99, calc(29% * var(--saturation-factor)), 47%) 92%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 8%)",
	"--ansi-bg-bright-magenta": "color-mix(in srgb, hsl(305, calc(35% * var(--saturation-factor)), 65%) 92%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 8%)",
	"--ansi-bg-bright-red": "color-mix(in srgb, hsl(0, calc(88% * var(--saturation-factor)), 62%) 92%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 8%)",
	"--ansi-bg-bright-white": "color-mix(in srgb, hsl(0, 0%, 100%) 92%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 8%)",
	"--ansi-bg-bright-yellow": "color-mix(in srgb, hsl(41, calc(53% * var(--saturation-factor)), 67%) 92%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 8%)",
	"--ansi-bg-cyan": "color-mix(in srgb, hsl(168, calc(53% * var(--saturation-factor)), 55%) 88%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 12%)",
	"--ansi-bg-green": "color-mix(in srgb, hsl(99, calc(29% * var(--saturation-factor)), 47%) 88%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 12%)",
	"--ansi-bg-magenta": "color-mix(in srgb, hsl(305, calc(35% * var(--saturation-factor)), 65%) 88%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 12%)",
	"--ansi-bg-red": "color-mix(in srgb, hsl(0, calc(88% * var(--saturation-factor)), 62%) 88%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 12%)",
	"--ansi-bg-white": "color-mix(in srgb, hsl(0, 0%, 83%) 88%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 12%)",
	"--ansi-bg-yellow": "color-mix(in srgb, hsl(41, calc(53% * var(--saturation-factor)), 67%) 88%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%) 12%)",
	"--ansi-fg-black": "color-mix(in srgb, hsl(0, 0%, 12%) 72%, hsl(210, calc(6% * var(--saturation-factor)), 70.4%) 28%)",
	"--ansi-fg-blue": "color-mix(in srgb, hsl(207, calc(61% * var(--saturation-factor)), 59%) 92%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 90.36%) 82%, hsl(340, calc(50% * var(--saturation-factor)), 90%) 18%) 8%)",
	"--ansi-fg-bright-black": "color-mix(in srgb, hsl(0, 0%, 50%) 86%, hsl(210, calc(6% * var(--saturation-factor)), 70.4%) 14%)",
	"--ansi-fg-bright-blue": "color-mix(in srgb, hsl(207, calc(61% * var(--saturation-factor)), 59%) 94%, hsl(210, calc(6% * var(--saturation-factor)), 96%) 6%)",
	"--ansi-fg-bright-cyan": "color-mix(in srgb, hsl(168, calc(53% * var(--saturation-factor)), 55%) 94%, hsl(210, calc(6% * var(--saturation-factor)), 96%) 6%)",
	"--ansi-fg-bright-green": "color-mix(in srgb, hsl(99, calc(29% * var(--saturation-factor)), 47%) 88%, hsl(210, calc(6% * var(--saturation-factor)), 96%) 12%)",
	"--ansi-fg-bright-magenta": "color-mix(in srgb, hsl(305, calc(35% * var(--saturation-factor)), 65%) 94%, hsl(210, calc(6% * var(--saturation-factor)), 96%) 6%)",
	"--ansi-fg-bright-red": "color-mix(in srgb, hsl(0, calc(88% * var(--saturation-factor)), 62%) 94%, hsl(210, calc(6% * var(--saturation-factor)), 96%) 6%)",
	"--ansi-fg-bright-white": "hsl(210, calc(6% * var(--saturation-factor)), 96%)",
	"--ansi-fg-bright-yellow": "color-mix(in srgb, hsl(41, calc(53% * var(--saturation-factor)), 67%) 94%, hsl(210, calc(6% * var(--saturation-factor)), 96%) 6%)",
	"--ansi-fg-cyan": "color-mix(in srgb, hsl(168, calc(53% * var(--saturation-factor)), 55%) 92%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 90.36%) 82%, hsl(340, calc(50% * var(--saturation-factor)), 90%) 18%) 8%)",
	"--ansi-fg-green": "color-mix(in srgb, hsl(99, calc(29% * var(--saturation-factor)), 47%) 92%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 90.36%) 82%, hsl(340, calc(50% * var(--saturation-factor)), 90%) 18%) 8%)",
	"--ansi-fg-magenta": "color-mix(in srgb, hsl(305, calc(35% * var(--saturation-factor)), 65%) 92%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 90.36%) 82%, hsl(340, calc(50% * var(--saturation-factor)), 90%) 18%) 8%)",
	"--ansi-fg-red": "color-mix(in srgb, hsl(0, calc(88% * var(--saturation-factor)), 62%) 92%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 90.36%) 82%, hsl(340, calc(50% * var(--saturation-factor)), 90%) 18%) 8%)",
	"--ansi-fg-white": "color-mix(in srgb, hsl(0, 0%, 83%) 88%, hsl(210, calc(6% * var(--saturation-factor)), 90.36%) 12%)",
	"--ansi-fg-yellow": "color-mix(in srgb, hsl(41, calc(53% * var(--saturation-factor)), 67%) 92%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 90.36%) 82%, hsl(340, calc(50% * var(--saturation-factor)), 90%) 18%) 8%)",
	"--ansi-inverse-bg": "color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 90.36%) 82%, hsl(340, calc(50% * var(--saturation-factor)), 90%) 18%)",
	"--ansi-inverse-text": "color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%)",
	"--avatar-stack-extra-height": "0.375rem",
	"--background-channel-header": "hsl(210, calc(6% * var(--saturation-factor)), 8.21%)",
	"--background-header-primary": "hsl(210, calc(6% * var(--saturation-factor)), 10.25%)",
	"--background-header-primary-hover": "hsl(210, calc(6% * var(--saturation-factor)), 12.75%)",
	"--background-header-secondary": "hsl(210, calc(6% * var(--saturation-factor)), 10.25%)",
	"--background-modifier-accent": "hsla(210, calc(13% * var(--saturation-factor)), 80%, 0.15)",
	"--background-modifier-accent-focus": "hsla(210, calc(13% * var(--saturation-factor)), 80%, 0.22)",
	"--background-modifier-hover": "hsla(210, calc(6% * var(--saturation-factor)), 100%, 0.05)",
	"--background-modifier-selected": "color-mix(in srgb, hsl(191, calc(100% * var(--saturation-factor)), 50%) 14%, hsla(0, 0%, 100%, 0.035))",
	"--background-primary": "hsl(210, calc(6% * var(--saturation-factor)), 2%)",
	"--background-secondary": "hsl(210, calc(6% * var(--saturation-factor)), 5.24%)",
	"--background-secondary-alt": "hsl(210, calc(6% * var(--saturation-factor)), 7.3%)",
	"--background-secondary-lighter": "hsl(210, calc(6% * var(--saturation-factor)), 6.31%)",
	"--background-tertiary": "hsl(210, calc(6% * var(--saturation-factor)), 9.04%)",
	"--background-textarea": "hsl(210, calc(6% * var(--saturation-factor)), 7.61%)",
	"--bg-active": "color-mix(in srgb, hsl(191, calc(100% * var(--saturation-factor)), 50%) 14%, hsla(0, 0%, 100%, 0.035))",
	"--bg-blockquote": "hsl(210, calc(6% * var(--saturation-factor)), 7.3%)",
	"--bg-code": "color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 88%, hsl(210, calc(6% * var(--saturation-factor)), 9.04%) 12%)",
	"--bg-code-block": "color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%)",
	"--bg-hover": "hsla(210, calc(6% * var(--saturation-factor)), 100%, 0.05)",
	"--bg-primary": "hsl(210, calc(6% * var(--saturation-factor)), 2%)",
	"--bg-secondary": "hsl(210, calc(6% * var(--saturation-factor)), 5.24%)",
	"--bg-table-header": "hsl(210, calc(6% * var(--saturation-factor)), 9.04%)",
	"--bg-table-row-even": "hsl(210, calc(6% * var(--saturation-factor)), 5.24%)",
	"--bg-table-row-odd": "hsl(210, calc(6% * var(--saturation-factor)), 2%)",
	"--bg-tertiary": "hsl(210, calc(6% * var(--saturation-factor)), 9.04%)",
	"--border-color": "hsla(210, calc(6% * var(--saturation-factor)), 50%, 0.2)",
	"--border-color-focus": "hsla(198, calc(92% * var(--saturation-factor)), 70%, 0.45)",
	"--border-color-hover": "hsla(210, calc(6% * var(--saturation-factor)), 50%, 0.3)",
	"--brand-primary": "hsl(191, calc(100% * var(--saturation-factor)), 50%)",
	"--brand-primary-fill": "hsl(0, 0%, 100%)",
	"--brand-primary-light": "hsl(191, calc(100% * var(--saturation-factor)), 72%)",
	"--brand-secondary": "hsl(191, calc(100% * var(--saturation-factor)), 42%)",
	...
	"--button-primary-active-fill": "hsl(191, calc(100% * var(--saturation-factor)), 42%)",
	"--button-primary-fill": "hsl(191, calc(100% * var(--saturation-factor)), 50%)",
	"--button-primary-text": "hsl(210, 80%, 6%)",
	...
	"--code-block-bg": "color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 92%, hsl(210, calc(6% * var(--saturation-factor)), 2%) 8%)",
	"--code-block-border": "color-mix(in srgb, hsla(210, calc(6% * var(--saturation-factor)), 50%, 0.2) 90%, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 90.36%) 82%, hsl(340, calc(50% * var(--saturation-factor)), 90%) 18%) 10%)",
	"--code-block-highlight": "color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 96%) 10%, transparent)",
	"--code-inline-bg": "color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 88%, hsl(210, calc(6% * var(--saturation-factor)), 9.04%) 12%)",
	"--code-muted": "color-mix(in srgb, color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 90.36%) 82%, hsl(340, calc(50% * var(--saturation-factor)), 90%) 18%) 42%, hsl(210, calc(6% * var(--saturation-factor)), 70.4%) 58%)",
	"--code-text": "color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 90.36%) 82%, hsl(340, calc(50% * var(--saturation-factor)), 90%) 18%)",
	...
	"--composer-surface-color": "hsl(210, calc(6% * var(--saturation-factor)), 6.31%)",
	"--content-padding": "1rem",
	"--content-padding-lg": "1.5rem",
	"--content-padding-sm": "0.75rem",
	"--control-button-active-bg": "hsl(210, calc(6% * var(--saturation-factor)), 24%)",
	"--control-button-active-text": "hsl(210, calc(6% * var(--saturation-factor)), 96%)",
	...
	"--control-button-hover-bg": "hsl(210, calc(6% * var(--saturation-factor)), 22%)",
	"--control-button-hover-text": "hsl(210, calc(6% * var(--saturation-factor)), 96%)",
	"--control-button-normal-bg": "transparent",
	"--control-button-normal-text": "hsl(210, calc(6% * var(--saturation-factor)), 81.42%)",
	...
	"--floating-surface-ring-color": "color-mix(in srgb, hsla(210, calc(13% * var(--saturation-factor)), 80%, 0.15) 20%, transparent)",
	"--floating-surface-ring-color-strong": "color-mix(in srgb, hsla(210, calc(13% * var(--saturation-factor)), 80%, 0.15) 45%, transparent)",
	"--focus-primary": "#00d1ff",
	...
	"--footer-box-radius": "0.75rem",
	"--footer-row-height": "calc(3.625rem + 0.375rem * 2)",
	"--form-surface-background": "hsl(210, calc(6% * var(--saturation-factor)), 9.04%)",
	...
	"--guild-badge-surface": "hsl(210, calc(6% * var(--saturation-factor)), 5.24%)",
	...
	"--guild-list-foreground": "hsl(210, calc(6% * var(--saturation-factor)), 8.77%)",
	...
	"--guilds-layout-item-bg": "hsl(210, calc(6% * var(--saturation-factor)), 8.77%)",
	...
	"--invite-verified-icon-color": "hsl(210, 80%, 6%)",
	"--layout-gap": "1rem",
	...
	"--layout-header-popout-width": "calc(15rem - (1rem * 2))",
	...
	"--lume-bg-canvas": "#050505",
	"--lume-bg-elevated": "#0d0d10",
	"--lume-bg-panel": "#08080a",
	"--lume-bg-rail": "#030304",
	"--lume-cyan": "#00d1ff",
	"--lume-cyan-line": "rgba(0, 209, 255, 0.2)",
	"--lume-cyan-soft": "rgba(0, 209, 255, 0.14)",
	"--lume-easing": "cubic-bezier(0.22, 1, 0.36, 1)",
	"--lume-glow": "0 0 2rem rgba(0, 209, 255, 0.1)",
	"--lume-line": "rgba(255, 255, 255, 0.055)",
	"--lume-shadow": "0 1.25rem 4rem rgba(0, 0, 0, 0.5)",
	...
	"--markup-interactive-hover-fill": "color-mix(in srgb, hsl(191, calc(100% * var(--saturation-factor)), 70%) 30%, transparent)",
	"--markup-interactive-hover-text": "hsl(191, calc(100% * var(--saturation-factor)), 70%)",
	"--markup-jump-link-fill": "color-mix(in srgb, hsl(191, calc(100% * var(--saturation-factor)), 70%) 12%, transparent)",
	"--markup-jump-link-hover-fill": "color-mix(in srgb, hsl(191, calc(100% * var(--saturation-factor)), 70%) 20%, transparent)",
	"--markup-jump-link-text": "hsl(191, calc(100% * var(--saturation-factor)), 70%)",
	"--markup-mention-border": "hsla(191, calc(100% * var(--saturation-factor)), 70%, 0.3)",
	"--markup-mention-fill": "color-mix(in srgb, hsl(191, calc(100% * var(--saturation-factor)), 70%) 20%, transparent)",
	"--markup-mention-text": "hsl(191, calc(100% * var(--saturation-factor)), 70%)",
	...
	"--message-timestamp-color": "hsl(210, calc(6% * var(--saturation-factor)), 81.42%)",
	...
	"--panel-control-bg": "color-mix( in srgb, hsl(210, calc(6% * var(--saturation-factor)), 7.3%) 90%, hsl(210, calc(8% * var(--saturation-factor)), 2%) 10% )",
	"--panel-control-border": "hsla(210, calc(30% * var(--saturation-factor)), 65%, 0.45)",
	"--panel-control-divider": "hsla(210, calc(30% * var(--saturation-factor)), 55%, 0.35)",
	"--panel-control-highlight": "hsla(0, 0%, 100%, 0.04)",
	"--plutonium": "hsl(191, calc(100% * var(--saturation-factor)), 50%)",
	"--plutonium-hover": "hsl(191, calc(100% * var(--saturation-factor)), 42%)",
	"--plutonium-icon": "hsl(38, calc(92% * var(--saturation-factor)), 50%)",
	"--plutonium-text": "hsl(210, 80%, 6%)",
	"--radius-2xl": "1.25rem",
	...
	"--skeleton-chrome-border": "0.0625rem solid color-mix(in srgb, hsla(210, calc(13% * var(--saturation-factor)), 80%, 0.15) 25%, transparent)",
	"--skeleton-chrome-border-color": "color-mix(in srgb, hsla(210, calc(13% * var(--saturation-factor)), 80%, 0.15) 25%, transparent)",
	...
	"--surface-interactive-hover-bg": "hsla(210, calc(6% * var(--saturation-factor)), 100%, 0.05)",
	"--surface-interactive-selected-bg": "color-mix(in srgb, hsl(191, calc(100% * var(--saturation-factor)), 50%) 14%, hsla(0, 0%, 100%, 0.035))",
	"--surface-interactive-selected-color": "hsl(210, calc(6% * var(--saturation-factor)), 96%)",
	"--system-message-icon-opacity": "0.6",
	"--system-message-icon-size": "1.125rem",
	"--text-chat": "hsl(210, calc(6% * var(--saturation-factor)), 93.67%)",
	"--text-chat-muted": "hsl(210, calc(6% * var(--saturation-factor)), 81.42%)",
	"--text-code": "color-mix(in srgb, hsl(210, calc(6% * var(--saturation-factor)), 90.36%) 82%, hsl(340, calc(50% * var(--saturation-factor)), 90%) 18%)",
	"--text-link": "hsl(191, calc(100% * var(--saturation-factor)), 70%)",
	"--text-on-brand-primary": "hsl(210, 80%, 6%)",
	"--text-primary": "hsl(210, calc(6% * var(--saturation-factor)), 96%)",
	"--text-primary-muted": "hsl(210, calc(6% * var(--saturation-factor)), 81.42%)",
	"--text-secondary": "hsl(210, calc(6% * var(--saturation-factor)), 90.36%)",
	"--text-selection": "hsla(198, calc(92% * var(--saturation-factor)), 70%, 0.35)",
	"--text-tertiary": "hsl(210, calc(6% * var(--saturation-factor)), 70.4%)",
	"--text-tertiary-muted": "hsl(210, calc(6% * var(--saturation-factor)), 62.88%)",
	"--text-tertiary-secondary": "hsl(210, calc(6% * var(--saturation-factor)), 60%)",
	...
	"--user-area-divider-color": "color-mix(in srgb, hsla(210, calc(6% * var(--saturation-factor)), 100%, 0.05) 70%, transparent)",
...
export const THEME_STUDIO_LIGHT_DEFAULT_VARIABLE_VALUES: Readonly<Record<string, string>> = {
	...
	"--accent-info": "hsl(191, calc(100% * var(--saturation-factor)), 45%)",
	"--accent-primary": "hsl(191, calc(100% * var(--saturation-factor)), 50%)",
	"--accent-purple": "hsl(278, calc(85% * var(--saturation-factor)), 65%)",
	...
	"--alert-note-color": "hsl(191, calc(100% * var(--saturation-factor)), 45%)",
	...
	"--interactive-active": "color-mix( in oklab, hsl(0, calc(0% * var(--saturation-factor)), 100%) 100%, hsl(245, calc(100% * var(--saturation-factor)), 80%) 40% )",
	"--interactive-muted": "color-mix( in oklab, hsl(228, calc(10% * var(--saturation-factor)), 35%) 100%, hsl(245, calc(100% * var(--saturation-factor)), 80%) 40% )",
	"--invite-verified-icon-color": "hsl(191, calc(100% * var(--saturation-factor)), 50%)",
	"--layout-gap": "1rem",
	"--layout-gap-lg": "1.5rem",
	"--layout-gap-sm": "0.5rem",
	"--layout-guild-list-width": "4.5rem",
	...
	"--markup-interactive-hover-fill": "color-mix(in srgb, hsl(191, calc(100% * var(--saturation-factor)), 45%) 30%, transparent)",
	"--markup-interactive-hover-text": "hsl(191, calc(100% * var(--saturation-factor)), 45%)",
	"--markup-jump-link-fill": "color-mix(in srgb, hsl(191, calc(100% * var(--saturation-factor)), 45%) 8%, transparent)",
	"--markup-jump-link-hover-fill": "color-mix(in srgb, hsl(191, calc(100% * var(--saturation-factor)), 45%) 20%, transparent)",
	"--markup-jump-link-text": "hsl(191, calc(100% * var(--saturation-factor)), 45%)",
	"--markup-mention-border": "hsla(191, calc(100% * var(--saturation-factor)), 45%, 0.4)",
	"--markup-mention-fill": "color-mix(in srgb, hsl(191, calc(100% * var(--saturation-factor)), 45%) 20%, transparent)",
	"--markup-mention-text": "hsl(191, calc(100% * var(--saturation-factor)), 45%)",
	"--markup-restricted-inline-emoji-baseline-shift": "-0.18em",
	"--markup-restricted-inline-emoji-size": "1.25em",
	"--markup-restricted-inline-icon-baseline-shift": "-0.125em",
	"--markup-strikethrough-color": "currentColor",
	...
	"--text-link": "hsl(191, calc(100% * var(--saturation-factor)), 45%)",
	"--text-on-brand-primary": "hsl(210, 80%, 6%)",
