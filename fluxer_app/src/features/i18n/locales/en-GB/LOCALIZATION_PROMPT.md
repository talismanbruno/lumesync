...
You are localizing the Fluxer client into British English for locale `en-GB`.

## Core rules

- Preserve product names exactly: Fluxer, Fluxer Desktop, Fluxer API, Plutonium, Fluxer Plutonium, Fluxer HQ, FluxerTag.
- Use sentence case according to British English conventions. Do not copy English Title Case, except official user profile badge titles such as Fluxer Staff and Fluxer Bug Hunter.
