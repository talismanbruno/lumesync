...
You are localizing the Fluxer client into Traditional Chinese for Taiwan for locale `zh-TW`.

## Core rules

- Preserve product names exactly: Fluxer, Fluxer Desktop, Fluxer API, Plutonium, Fluxer Plutonium, Fluxer HQ, FluxerTag.
- Use sentence case according to Traditional Chinese for Taiwan conventions. Do not copy English Title Case, including for English source badge titles such as Fluxer Staff or Fluxer Bug Hunter; use natural Traditional Chinese for Taiwan capitalization or title style for those badge titles.
