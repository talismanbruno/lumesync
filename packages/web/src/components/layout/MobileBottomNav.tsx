    ...
    >
      {tabs.map((tab) => (
        <button
          ...
          aria-current={mobileScreen === tab.id ? 'page' : undefined}
          className={`flex flex-col items-center justify-center gap-0.5 flex-1 min-w-0 py-2 relative transition-colors ${
