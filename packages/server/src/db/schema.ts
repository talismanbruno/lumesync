...
export const instanceSettings = sqliteTable('instance_settings', {
  ...
  maxBitrateKbps: integer('max_bitrate_kbps').notNull().default(6000),
  ...
  maxVoiceParticipantsPerRoom: integer('max_voice_participants_per_room').notNull().default(15),
  maxConcurrentVoiceParticipants: integer('max_concurrent_voice_participants').notNull().default(20),
